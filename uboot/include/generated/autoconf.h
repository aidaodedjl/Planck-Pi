...
#define CONFIG_BOOTARGS "console=ttyS0,115200 panic=5 rootwait root=/dev/mmcblk0p3 earlyprintk rw"
...
#define CONFIG_BOOTCOMMAND "load mmc 0:2 0x80C00000 suniv-f1c100s-generic.dtbload mmc 0:2 0x80008000 zImagebootz 0x80008000 - 0x80C00000"
